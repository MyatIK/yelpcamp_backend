                ...
                <div className="m-5 p-2 lg:col-span-3 lg:m-10 lg:p-20">
                    ...
                    <form className="mt-20 lg:mt-20">
                        <fieldset>
                            ...
                            <input id="username" value={name} onChange={(e)=>setName(e.target.value)} className="block bg-stone-100 rounded p-3 w-4/5 lg:w-full" type="text" placeholder='johndoe_91'/>
                    ...
                    <Link to="/Login"><button className="rounded bg-black text-white p-3 w-full mt-3" disabled={!isEnabled}>Create an account</button></Link>
